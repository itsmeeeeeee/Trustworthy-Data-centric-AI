...
if __name__ == '__main__':
    ...
    df = pd.read_csv(f'data/outputs/potato/text_{TASK}_potato.csv')
    ...
    for input_sample in formatted_data:
        ...
        while inference_not_done:
            try:
                ...
                with open(f'data/outputs/{TASK}_evaluation/gpt4_as_annotator/full_log_new.jsonl', 'w') as f:
                    ndjson.dump(full_log, f)
                with open(f'data/outputs/{TASK}_evaluation/gpt4_as_annotator/output_new.jsonl', 'w') as f:
